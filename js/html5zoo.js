        ...
        J.prototype = {
            ...
            slideRun: function(a) {
                ...
                if (this.isAnimating) {
                    ...
                    $(".html5zoo-img-box-" + this.id, this.container).unbind('transitionFinished').html("<div class='html5zoo-img-" + this.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:auto;'><img style='position:absolute;max-width:100%;height:auto;left:50%;top:0%;margin-left:-1000px;' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>");
